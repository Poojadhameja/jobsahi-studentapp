          ...
          children: [
            ...
            Padding(
              ...
              child: Wrap(
                spacing: 8,
                children: const [
                  Chip(label: Text("Full-Time", style: TextStyle(color: Colors.white)), backgroundColor: Colors.blue),
                  Chip(label: Text("On-Site", style: TextStyle(color: Colors.white)), backgroundColor: Colors.blue),
                  Chip(label: Text("Apprenticeship", style: TextStyle(color: Colors.white)), backgroundColor: Colors.blue),
                ],
              ),
            ),
            Padding(
              ...
              children: [
                Column(
                  children: const [
                    ...
                    Text("/5"),
                    Text("2.7k Review", style: TextStyle(color: Colors.black54)),
                  ],
                ),
